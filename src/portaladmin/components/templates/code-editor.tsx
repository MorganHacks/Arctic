...
const colors = HighlightStyle.define([
  { tag: [tags.tagName, tags.keyword], color: "var(--code-keyword)" },
  { tag: [tags.attributeName, tags.propertyName, tags.function(tags.variableName)], color: "var(--code-property)" },
  { tag: [tags.string, tags.attributeValue], color: "var(--code-string)" },
  { tag: [tags.number, tags.bool, tags.typeName, tags.className], color: "var(--code-number)" },
  { tag: [tags.punctuation, tags.angleBracket, tags.operator], color: "var(--muted)" },
...
const theme = EditorView.theme({
  ...
  "&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": { backgroundColor: "color-mix(in srgb, var(--accent) 14%, transparent)" },
  ".cm-matchingBracket": { backgroundColor: "color-mix(in srgb, var(--accent) 8%, transparent)", outline: "1px solid color-mix(in srgb, var(--accent) 22%, transparent)" },
